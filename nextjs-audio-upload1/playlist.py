...
audio_folder = "C:/Users/bhave/Documents/Epoch 2.0/nextjs-audio-upload1/public/uploads"
...
def download_songs(token,playlist_id):
    ids = get_playlist_tracks(token, playlist_id)
...
def main():
    ...
    if auth_code:
        ...
        if access_token:
            ...
            download_songs(access_token, playlist_id)
